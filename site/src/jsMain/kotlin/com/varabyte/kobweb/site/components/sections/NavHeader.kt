                ...
                DisposableEffect(Unit) {
                    ...
                    docsearch(
                        json(
                            ...
                            // Using sample data: https://docsearch.algolia.com/docs/docsearch-v3#testing
                            "appId" to "R2IYF7ETH7",
                            "apiKey" to "599cec31baffa4868cae4e79f180729b",
                            "indexName" to "docsearch",
                            "hitComponent" to { data: dynamic ->
                                val url = "/docs/concepts/foundation/routing#package" // data.hit.url
                            ...
                            "navigator" to json(
                                ...
                                "navigate" to { data: dynamic ->
                                    val url = "/docs/concepts/foundation/routing#package" // data.itemUrl
                                    kobwebNavigate(url)
                                }
                            )
                        )
