...
It is common to want to use a custom font on your site. Setting this up is fairly easy, and you have two suggested
approaches.
...
> in the next section on self-hosted fonts.
