...
such as ${DocsLink("API routes", "fullstack#define-api-routes")} and live reloading.
...
The Kobweb Gradle Application plugin provides a way to notify it about your server plugin project. Set it up, and Gradle
will build and copy your plugin jar over for you automatically.
