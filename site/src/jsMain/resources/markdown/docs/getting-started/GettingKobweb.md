...
[grab the zip or tar file from the GitHub](https://github.com/varabyte/kobweb-cli/releases/tag/v0.9.22) or you can fetch
...
| Downloaded from Github | Visit the [latest release](https://github.com/varabyte/kobweb-cli/releases/tag/v0.9.22). You can find both a zip and tar file there. |
